            ...
            <div class="px-10 pa-5 v-card v-sheet ">
                <div class="row flex align-center dallas-history-section">
                    <div class="col-sm-3 col-12">
                        <img src="{{ url('images/bigtex.jpg')}}" style="width:100%;"/>
                    </div>
                ...
                <div class="row flex align-center dallas-history-section">
                    ...
                    <div class="col-sm-4 col-12">
                        <img src="{{ url('images/flag_texas.jpg')}}" style="width:100%;"/>
                    </div>
                </div>
                <div class="row flex align-center dallas-history-section">
                    <div class="col-sm-4 col-12">
                        <img src="{{ url('images/dallas-city.jpg')}}" style="width:100%;"/>
                    </div>
                    <div class="col-sm-8 col-12"> 
                ...
                <div class="row flex align-center dallas-history-section">
                    ...
                    <div class="col-sm-4 col-12">
                        <img src="{{ url('images/State-Fair-of-Texas-auto-show.jpg')}}" style="width:100%;"/>
                    </div>
                </div>
            </div>
        </div>
