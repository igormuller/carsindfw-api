            ...
            <div class="px-10 pa-5 v-card v-sheet ">
                <div class="row flex align-center dallas-history-section">
                    <div class="col-sm-3 col-12">
                        <img src="https://carsindfw.com/img/bigtex.ed604dd0.jpg" style="width:100%;"/>
                    </div>
                ...
                <div class="row flex align-center dallas-history-section">
                    ...
                    <div class="col-sm-4 col-12">
                        <img src="https://carsindfw.com/img/flag_texas.0c53230e.jpg" style="width:100%;"/>
                    </div>
                </div>
                <div class="row flex align-center dallas-history-section">
                    <div class="col-sm-4 col-12">
                        <img src="https://carsindfw.com/img/dallas-city.85f4e525.jpg" style="width:100%;"/>
                    </div>
                    <div class="col-sm-8 col-12"> 
                ...
                <div class="row flex align-center dallas-history-section">
                    ...
                    <div class="col-sm-4 col-12">
                        <img src="https://carsindfw.com/img/State-Fair-of-Texas-auto-show.22d4ec4f.jpg" style="width:100%;"/>
                    </div>
                </div>
            </div>
        </div>
